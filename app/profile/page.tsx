            ...
            <div className='border-2 border-white p-4 rounded-lg mt-4'>
                ...
                <form onSubmit={handleSubmit} className='mt-4 flex flex-col gap-4'>
                    <label className='flex w-full md:w-[60vw] flex-col md:flex-row'>
                        <div className="w-full md:w-[30%]">Github Profile Link:</div>
                    ...
                    <label className='flex w-full md:w-[60vw] flex-col md:flex-row'>
                        <div className="w-full md:w-[30%]">Phone num:</div>
                        <textarea value={phoneNum} onChange={(e) => setPhoneNum(e.target.value)} className='rounded-lg p-1 text-black' />
                    </label>
                    <button type="submit" className='bg-[#5cdb5c] px-4 py-2 rounded-lg mx-auto w-fit'   >Complete Profile</button>
                </form>
            </div>
        </main>
    );
