...
export default function Hero() {
  ...
  return (
    <main
      id="hero"
      className="flex h-screen w-full flex-col justify-between items-center bg-hero-background bg-no-repeat bg-cover bg-black px-[1rem] py-[0.5rem] gap-[1rem] overflow-x-hidden relative mobile:bg-fixed"
    >
      <Navbar />
