  ...
  return (
    <main className="w-full flex justify-around items-start laptop:min-h-[80vh] laptop:flex-row mobile:flex-col mobile:px-[1rem]">
      ...
      <section className="flex flex-col laptop:w-[52%] gap-[12px] laptop:h-full mobile:w-full mobile:gap-[1rem]">
        <div className=" laptop:text-[375px] laptop:h-[360px] text-transparent bg-clip-text border-[1px] border-[#292929] rounded-[20px]  bg-gradient-radial from-[#B6C2FF] to-[#00051D] font-schabo  whitespace-nowrap   justify-between items-center leading-none flex mobile:text-[100px] mobile:text-center  ">
          <p className="w-fit laptop:mt-[90px] mobile:mt-[25px] marquee px-[0.6rem]">ANNUAL TECH FEST</p>
          <p className="w-fit laptop:mt-[90px] mobile:mt-[25px] marquee px-[0.6rem]"> ANNUAL TECH FEST</p>
        </div>
