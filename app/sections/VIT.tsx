export default function VIT(){
    return (
        <main className="w-full flex justify-around items-start h-screen">
            ...
            <section className="flex flex-col w-[52%] gap-[12px] h-auto">
               
                <div className="font-ptMono leading-9 text-white text-2xl border-[1px] border-[#292929] rounded-[20px] px-[28px] py-[28px] min-h-[70vh]">
